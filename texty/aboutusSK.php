...
<h3>Vedenie ústavu</h3>
<table>
    <tr>
        <td>Riaditeľ ústavu</td><td>prof. Ing. Mikuláš Huba, PhD.</td>
    </tr><tr>
        <td>Zástupca riaditeľa ústavu pre vedeckú činnosť</td><td>prof. Ing. Justín Murín, DrSc.</td>
    </tr><tr>
        <td>Zástupca riaditeľa ústavu pre rozvoj ústavu</td><td>prof. Ing. Štefan Kozák, PhD.</td>
    </tr><tr>
        <td>Zástupca riaditeľa ústavu pre pedagogickú činnosť</td><td>doc. Ing. Katarína Žáková, PhD.</td>
    </tr>
</table>
<br>

<h3>Oddelenia ústavu automobilovej mechatroniky</h3>
<table>
    <tr>
        <td colspan="2"> Oddelenie aplikovanej mechaniky a mechatroniky (OAMM)</td>
    </tr><tr>
        <td>Vedúci:</td><td>prof. Ing. Justín Murín, DrSc.</td>
    </tr><tr>
        <td>Zástupca:</td><td>doc. Ing. Vladimír Kutiš, PhD.</td>
    </tr><tr>

        <td colspan="2"> Oddelenie informačných, komunikačných a riadiacich systémov (OIKR)</td>
    </tr><tr>
        <td>Vedúci:</td><td>doc. Ing. Danica Rosinová, PhD.</td>
    </tr><tr>
        <td>Zástupca:</td><td>doc. Ing. Katarína Žáková, PhD.</td>
    </tr><tr>

        <td colspan="2"> Oddelenie elektroniky, mikropočítačov a PLC systémov (OEMP)</td>
    </tr><tr>
        <td>Vedúci:</td><td>prof. Ing. Štefan Kozák, PhD.</td>
    </tr><tr>
        <td>Zástupca:</td><td>Ing. Richard Balogh, PhD.</td>
    </tr><tr>

        <td colspan="2"> Oddelenie E-mobility, automatizácie a pohonov (OEAP)</td>
    </tr><tr>
        <td>Vedúci:</td><td>prof. Ing. Mikuláš Huba, PhD.</td>
    </tr><tr>
...
<table>
    <tr>
        <td colspan="2"><h4>Oddelenie aplikovanej mechaniky a mechatroniky (OAMM)</h4></td>
    </tr><tr>
        <td>Vedúci:</td><td>prof. Ing. Justín Murín, DrSc.</td>
    </tr><tr>
        <td>Zástupca:</td><td>doc. Ing. Vladimír Kutiš, PhD.</td>
...
<table>
    <tr>
        <td colspan="2"><h4>Oddelenie informačných, komunikačných a riadiacich systémov (OIKR)</h4></td>
    </tr><tr>
        <td>Vedúci:</td><td>doc. Ing. Danica Rosinová, PhD.</td>
    </tr><tr>
        <td>Zástupca:</td><td>doc. Ing. Katarína Žáková, PhD.</td>
...
<table>
    <tr>
        <td colspan="2"><h4>Oddelenie elektroniky, mikropočítačov a PLC systémov (OEMP)</h4></td>
    </tr><tr>
        <td>Vedúci:</td><td>prof. Ing. Štefan Kozák, PhD.</td>
    </tr><tr>
        <td>Zástupca:</td><td>Ing. Richard Balogh, PhD.</td>
...
<table>
    <tr>
        <td colspan="2"><h4>Oddelenie E-mobility, automatizácie a pohonov (OEAP)</h4></td>
    </tr><tr>
        <td>Vedúci:</td><td>prof. Ing. Mikuláš Huba, PhD.</td>
    </tr><tr>
        <td>Zástupca:</td><td>prof. Ing. Viktor Ferencey, CSc.</td>
